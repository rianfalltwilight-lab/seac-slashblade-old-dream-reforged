...
本版更新与验证：[说明](docs/releases/0.2.0-dev.3.md)。

**[⬇ 直接下载旧梦重铸 0.2.0-dev.3 运行 JAR](https://github.com/rianfalltwilight-lab/seac-slashblade-old-dream-reforged/releases/download/v0.2.0-dev.3/SEAC-SlashBlade-Old-Dream-Reforged-1.21.1-0.2.0-dev.3.jar)**

适用于 Minecraft 1.21.1；下载后放入 mods。无需下载源码或选择 Git 标签。

非官方 SlashBlade: Resharpened 双端附属，当前 **0.2.0-dev.3**。以 **mc1.7.10-r87** 为主动行为基准，保留现代保护接口及明确兼容适配。开发预发布，未部署生产。
...
恢复旧连段、范围与伤害、幻影剑/剑阵/SB、九种基础 SA、附魔/锻造/断刀/刀魂与修复；保留配置生命周期修正、第一人称视角补偿、收刀嘲讽和神钢抢夺 III。详情与外部候选关系见 [更新说明](docs/releases/0.2.0-dev.3.md) 和 [验证范围](VALIDATION.md)。
