...
See [release notes](docs/releases/0.3.0-dev.2.md), [validation](VALIDATION.md), [third-party attribution](THIRD-PARTY-NOTICES.md) and [AI disclosure](AI-GENERATED.md). Independent code is MIT; legacy-derived portions retain original r87 and 1.12 terms.