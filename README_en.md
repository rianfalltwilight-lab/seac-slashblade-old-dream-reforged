...
The current version is **0.1.0-dev.11**. It is a development prerelease. Real-client feel, high-latency multiplayer, and production-pack acceptance remain incomplete, so test it against a backed-up world first.
