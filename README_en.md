...
**[⬇ Download 0.2.0-dev.7 runtime JAR](https://github.com/rianfalltwilight-lab/seac-slashblade-old-dream-reforged/releases/download/v0.2.0-dev.7/SEAC-SlashBlade-Old-Dream-Reforged-1.21.1-0.2.0-dev.7.jar)**

For Minecraft 1.21.1. Place the downloaded JAR in mods.

Version **0.2.0-dev.7**, development prerelease. Active reference: **SlashBlade mc1.7.10-r87**. Minecraft 1.21.1 / NeoForge 21.1.248 / Java 21. Required Resharpened dependency is tested at 2.0.5-1.21.1; relaxed version metadata does not guarantee compatibility with other internal APIs.
...
See [release notes](docs/releases/0.2.0-dev.7.md), [validation](VALIDATION.md), [third-party attribution](THIRD-PARTY-NOTICES.md) and [AI disclosure](AI-GENERATED.md). Independent code is MIT; legacy-derived portions retain original r87 and 1.12 terms.